...
ImsImageLineEdit::ImsImageLineEdit(QWidget *parent)
    : QLineEdit(parent)
{
    mImageLabel = NULL;
    mImagePath = "";
...
ImsImageLineEdit::ImsImageLineEdit(const QString & contents, QWidget *parent)
...
ImsImageLineEdit::ImsImageLineEdit(const QString & contents, const QString & pic, QWidget *parent)
    : QLineEdit(contents, parent)
{
    mImageLabel = NULL;
    mImagePath = pic;
