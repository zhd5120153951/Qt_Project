...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_frmConfig_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 98, 22)
    ...
    "on_btnClearPoll_clicked\0on_btnClearAll_clicked\0"
};
...
const QMetaObject frmConfig::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_frmConfig.data,
      qt_meta_data_frmConfig,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_frmConfig.stringdata))
