...
void NavbarWidget::addPage()
{
    bool ok;
    QString text = QInputDialog::getText(this, "Add new page", "Page text:",
                                         QLineEdit::Normal, "New Page", &ok);
    if (ok && !text.isEmpty())
    {
...
void NavbarWidget::insertPage()
{
    bool ok;
    QString text = QInputDialog::getText(this, "Insert new page", "Page text:",
                                         QLineEdit::Normal, "New Page", &ok);
    if (ok && !text.isEmpty())
    {
