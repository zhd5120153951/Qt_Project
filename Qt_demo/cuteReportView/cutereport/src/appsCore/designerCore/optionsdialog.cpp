    ...
    m_core(core)
{
    ...
    QByteArray geometry = m_core->reportCore()->settings()->value("Designer/OptionsDialogGeometry").toByteArray();
    if (!geometry.isNull())
...
OptionsDialog::~OptionsDialog()
{
    ...
    m_core->reportCore()->settings()->setValue("Designer/OptionsDialogGeometry", this->saveGeometry());
