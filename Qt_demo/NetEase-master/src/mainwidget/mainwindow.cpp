    ...
    : BasedWidget(parent)
{
    ...
    setWindowTitle(QStringLiteral("网易云音乐"));
...
void MainWindow::closeEvent(QCloseEvent *)
{
    ...
    if (m_saveUserInfo == 0)
    {
        int button = QMessageBox::warning(this, QStringLiteral("保存用户信息.."),
                                                QStringLiteral("即将退出网易云音乐,你是否要保存用户信息?"),
...
void MainWindow::initMenu()
{
    ...
    QAction *quit = new QAction(QStringLiteral("退出"), m_menu);
    QAction *showNor = new QAction(QStringLiteral("显示主窗口"), m_menu);
