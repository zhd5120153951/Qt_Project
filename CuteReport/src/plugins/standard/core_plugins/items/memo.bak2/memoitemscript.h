...
static const BaseItemInterface::Frame qtscript_Memo_Frame_values[] = {
...
static const char * const qtscript_Memo_Frame_keys[] = {
    "DrawLeft",
    "DrawRight",
    "DrawTop",
    "DrawBottom"
...
static int Memo_Frame_num = 4;


static QString qtscript_Memo_Frame_toStringHelper(BaseItemInterface::Frame value)
{
...
static QScriptValue qtscript_Memo_Frame_toScriptValue(QScriptEngine *engine, const BaseItemInterface::Frame &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Memo"));
    return clazz.property(qtscript_Memo_Frame_toStringHelper(value));
}


static void qtscript_Memo_Frame_fromScriptValue(const QScriptValue &value, BaseItemInterface::Frame &out)
{
    out = qvariant_cast<BaseItemInterface::Frame>(value.toVariant());
}


static QScriptValue qtscript_construct_Memo_Frame(QScriptContext *context, QScriptEngine *engine)
{
...
static QScriptValue qtscript_Memo_Frame_valueOf(QScriptContext *context, QScriptEngine *engine)
{
...
static QScriptValue qtscript_Memo_Frame_toString(QScriptContext *context, QScriptEngine *engine)
{
    BaseItemInterface::Frame value = qscriptvalue_cast<BaseItemInterface::Frame>(context->thisObject());
    return QScriptValue(engine, qtscript_Memo_Frame_toStringHelper(value));
}


static QScriptValue qtscript_create_Memo_Frame_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
                            engine, qtscript_construct_Memo_Frame,
                            qtscript_Memo_Frame_valueOf, qtscript_Memo_Frame_toString);

    qScriptRegisterMetaType<BaseItemInterface::Frame>(engine, qtscript_Memo_Frame_toScriptValue,
                                                   qtscript_Memo_Frame_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));

    for (int i = 0; i < Memo_Frame_num; ++i) {
        clazz.setProperty(QString::fromLatin1(qtscript_Memo_Frame_keys[i]),
                          engine->newVariant(qVariantFromValue(qtscript_Memo_Frame_values[i])),
...
QString Memo_Frame_toString(BaseItemInterface::Frame value)
{
    int idx = -1;
    for (int i = 0; i < Memo_Frame_num; ++i) {
        if (qtscript_Memo_Frame_values[i] == value) {
            idx = i;
            break;
        }
    }
    ...
    if (idx == -1) {
        CuteReport::ReportCore::log(LogError, "BaseItemInterface", "Memo_Frame_toString", QString("Value \'%1\' is not within range").arg((int)value));
        return QString();
    }

    return QString(qtscript_Memo_Frame_keys[idx]);
}


BaseItemInterface::Frame Memo_Frame_fromString(const QString &value, bool *ok)
{
    QString strIn = value.toLower();
    int idx = -1;
    for (int i = 0; i < Memo_Frame_num; ++i) {
        QString str(qtscript_Memo_Frame_keys[i]);
    ...
    if (idx == -1) {
        CuteReport::ReportCore::log(LogError, "BaseItemInterface", "Memo_Frame_fromString", QString("Value \'%1\' is not within range").arg(value));
        if (ok)
            *ok = false;
    }

    return BaseItemInterface::Frame(qtscript_Memo_Frame_values[idx]);
}


/** ======================= ResizeFlags =========================== */

static const BaseItemInterface::ResizeFlags qtscript_Memo_ResizeFlags_values[] = {
...
static const char * const qtscript_Memo_ResizeFlags_keys[] = {
    "Fixed",
    "ResizeLeft",
    "ResizeRight",
    "ResizeTop",
...
static int Memo_ResizeFlags_num = 6;


static QString qtscript_Memo_ResizeFlags_toStringHelper(BaseItemInterface::ResizeFlags value)
{
    const QMetaObject meta = BaseItemInterface::staticMetaObject;
...
static QScriptValue qtscript_Memo_ResizeFlags_toScriptValue(QScriptEngine *engine, const BaseItemInterface::ResizeFlags &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Memo"));
    return clazz.property(qtscript_Memo_ResizeFlags_toStringHelper(value));
}


static void qtscript_Memo_ResizeFlags_fromScriptValue(const QScriptValue &value, BaseItemInterface::ResizeFlags &out)
{
    out = qvariant_cast<BaseItemInterface::ResizeFlags>(value.toVariant());
}


static QScriptValue qtscript_construct_Memo_ResizeFlags(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    const QMetaObject *meta = qtscript_Qt_metaObject();
    int idx = meta->indexOfEnumerator("ResizeFlags");
...
static QScriptValue qtscript_Memo_ResizeFlags_valueOf(QScriptContext *context, QScriptEngine *engine)
{
...
static QScriptValue qtscript_Memo_ResizeFlags_toString(QScriptContext *context, QScriptEngine *engine)
{
    BaseItemInterface::ResizeFlags value = qscriptvalue_cast<BaseItemInterface::ResizeFlags>(context->thisObject());
    return QScriptValue(engine, qtscript_Memo_ResizeFlags_toStringHelper(value));
}


static QScriptValue qtscript_create_Memo_ResizeFlags_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
                            engine, qtscript_construct_Memo_ResizeFlags,
                            qtscript_Memo_ResizeFlags_valueOf, qtscript_Memo_ResizeFlags_toString);

    qScriptRegisterMetaType<BaseItemInterface::ResizeFlags>(engine, qtscript_Memo_ResizeFlags_toScriptValue,
                                                   qtscript_Memo_ResizeFlags_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));

    for (int i = 0; i < Memo_ResizeFlags_num; ++i) {
        clazz.setProperty(QString::fromLatin1(qtscript_Memo_ResizeFlags_keys[i]),
                          engine->newVariant(qVariantFromValue(qtscript_Memo_ResizeFlags_values[i])),
                          QScriptValue::ReadOnly | QScriptValue::Undeletable);
    }
...
QString Memo_ResizeFlags_toString(BaseItemInterface::ResizeFlags value)
{
    int idx = -1;
    for (int i = 0; i < Memo_ResizeFlags_num; ++i) {
        if (qtscript_Memo_ResizeFlags_values[i] == value) {
            idx = i;
            break;
        }
    }
    ...
    if (idx == -1) {
        CuteReport::ReportCore::log(LogError, "BaseItemInterface", "Memo_ResizeFlags_toString", QString("Value \'%1\' is not within range").arg((int)value));
        return QString();
    }

    return QString(qtscript_Memo_ResizeFlags_keys[idx]);
}


BaseItemInterface::ResizeFlags Memo_ResizeFlags_fromString(const QString &value, bool *ok)
{
    QString strIn = value.toLower();
    int idx = -1;
    for (int i = 0; i < Memo_ResizeFlags_num; ++i) {
        QString str(qtscript_Memo_ResizeFlags_keys[i]);
        if (strIn == str.toLower()) {
            idx = i;
            break;
        }
    ...
    if (idx == -1) {
        CuteReport::ReportCore::log(LogError, "BaseItemInterface", "Memo_ResizeFlags_fromString", QString("Value \'%1\' is not within range").arg(value));
        if (ok)
            *ok = false;
    }

    return BaseItemInterface::ResizeFlags(qtscript_Memo_ResizeFlags_values[idx]);
}


/** ======================= ShiftMode =========================== */

static const ItemInterface::ShiftMode qtscript_Memo_ShiftMode_values[] = {
    ItemInterface::AlwaysShift,
    ItemInterface::DontShift,
    ItemInterface::ShiftWhenOverlapped
};

static const char * const qtscript_Memo_ShiftMode_keys[] = {
    "AlwaysShift",
    "DontShift",
    "ShiftWhenOverlapped"
};

static int Memo_ShiftMode_num = 3;


static QString qtscript_Memo_ShiftMode_toStringHelper(ItemInterface::ShiftMode value)
{
...
static QScriptValue qtscript_Memo_ShiftMode_toScriptValue(QScriptEngine *engine, const ItemInterface::ShiftMode &value)
{
    QScriptValue clazz = engine->globalObject().property(QString::fromLatin1("Memo"));
    return clazz.property(qtscript_Memo_ShiftMode_toStringHelper(value));
}


static void qtscript_Memo_ShiftMode_fromScriptValue(const QScriptValue &value, ItemInterface::ShiftMode &out)
{
    out = qvariant_cast<ItemInterface::ShiftMode>(value.toVariant());
}


static QScriptValue qtscript_construct_Memo_ShiftMode(QScriptContext *context, QScriptEngine *engine)
{
    int arg = context->argument(0).toInt32();
    const QMetaObject *meta = qtscript_Qt_metaObject();
    int idx = meta->indexOfEnumerator("ShiftMode");
...
static QScriptValue qtscript_Memo_ShiftMode_valueOf(QScriptContext *context, QScriptEngine *engine)
{
...
static QScriptValue qtscript_Memo_ShiftMode_toString(QScriptContext *context, QScriptEngine *engine)
{
    ItemInterface::ShiftMode value = qscriptvalue_cast<ItemInterface::ShiftMode>(context->thisObject());
    return QScriptValue(engine, qtscript_Memo_ShiftMode_toStringHelper(value));
}


static QScriptValue qtscript_create_Memo_ShiftMode_class(QScriptEngine *engine, QScriptValue &clazz)
{
    QScriptValue ctor = qtscript_create_enum_class_helper(
                            engine, qtscript_construct_Memo_ShiftMode,
                            qtscript_Memo_ShiftMode_valueOf, qtscript_Memo_ShiftMode_toString);

    qScriptRegisterMetaType<ItemInterface::ShiftMode>(engine, qtscript_Memo_ShiftMode_toScriptValue,
                                                   qtscript_Memo_ShiftMode_fromScriptValue, ctor.property(QString::fromLatin1("prototype")));

    for (int i = 0; i < Memo_ShiftMode_num; ++i) {
        clazz.setProperty(QString::fromLatin1(qtscript_Memo_ShiftMode_keys[i]),
                          engine->newVariant(qVariantFromValue(qtscript_Memo_ShiftMode_values[i])),
                          QScriptValue::ReadOnly | QScriptValue::Undeletable);
    }
...
QString Memo_ShiftMode_toString(ItemInterface::ShiftMode value)
{
    int idx = -1;
    for (int i = 0; i < Memo_ShiftMode_num; ++i) {
        if (qtscript_Memo_ShiftMode_values[i] == value) {
            idx = i;
            break;
        }
    }
    ...
    if (idx == -1) {
        CuteReport::ReportCore::log(LogError, "ItemInterface", "Memo_ShiftMode_toString", QString("Value \'%1\' is not within range").arg((int)value));
        return QString();
    }

    return QString(qtscript_Memo_ShiftMode_keys[idx]);
}


ItemInterface::ShiftMode Memo_ShiftMode_fromString(const QString &value, bool *ok)
{
    QString strIn = value.toLower();
    int idx = -1;
    for (int i = 0; i < Memo_ShiftMode_num; ++i) {
        QString str(qtscript_Memo_ShiftMode_keys[i]);
        if (strIn == str.toLower()) {
            idx = i;
            break;
        }
    ...
    if (idx == -1) {
        CuteReport::ReportCore::log(LogError, "ItemInterface", "Memo_ShiftMode_fromString", QString("Value \'%1\' is not within range").arg(value));
        if (ok)
            *ok = false;
    }

    return ItemInterface::ShiftMode(qtscript_Memo_ShiftMode_values[idx]);
}
...
QScriptValue qtscript_create_MemoItem_class(QScriptEngine *engine)
{
    ...
    ctor.setProperty(QString::fromLatin1("Frame"), qtscript_create_Memo_Frame_class(engine, ctor));
    ctor.setProperty(QString::fromLatin1("ResizeFlags"), qtscript_create_Memo_ResizeFlags_class(engine, ctor));
    ctor.setProperty(QString::fromLatin1("ShiftMode"), qtscript_create_Memo_ShiftMode_class(engine, ctor));
