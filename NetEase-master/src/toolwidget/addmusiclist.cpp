    ...
    : QDialog(parent)
{
    ...
    m_checkPathButton = new QPushButton(QStringLiteral("浏览"));
    ...
    QLabel *nameLabel = new QLabel(QStringLiteral("歌单名称"));
    QLabel *pathLabel = new QLabel(QStringLiteral("歌曲路径"));
...
void AddMusicList::checkButtonClicked()
{
    ...
    m_files = QFileDialog::getOpenFileNames(this, QStringLiteral("添加音乐文件"),
                                            path, QStringLiteral("MP3 文件 (*.mp3);;全部文件 (*.*)"));
