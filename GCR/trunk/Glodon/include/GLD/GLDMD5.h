...
GLDCRYPTSHARED_EXPORT GString getMD5(const char *buffer, size_t bufSize);
GLDCRYPTSHARED_EXPORT GString getMD5(GStream *stream);
GLDCRYPTSHARED_EXPORT GString strMD5(const GString &buffer);
GLDCRYPTSHARED_EXPORT GString fileMD5(const GString &fileName);
