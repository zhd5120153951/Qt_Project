...
{
public:
    explicit QArrowWidget(const char *imgPath, GLDDockArrows *arrows, DockArea area, QWidget *parent)
...
GLDDockArrows::GLDDockArrows(QWidget *parent)
    : QObject(parent),
      leftWid(new QArrowWidget(":/icons/GLDDockPanel/left.png", this, LeftArea, parent)),
      rightWid(new QArrowWidget(":/icons/GLDDockPanel/right.png", this, RightArea, parent)),
      topWid(new QArrowWidget(":/icons/GLDDockPanel/top.png", this, TopArea, parent)),
      bottomWid(new QArrowWidget(":/icons/GLDDockPanel/bottom.png", this, BottomArea, parent)),
      centerWid(new QArrowWidget(":/icons/GLDDockPanel/center.png", this, CenterArea, parent)),
      centerLeftWid(new QArrowWidget(":/icons/GLDDockPanel/left.png", this, CenterLeftArea, parent)),
      centerRightWid(new QArrowWidget(":/icons/GLDDockPanel/right.png", this, CenterRightArea, parent)),
      centerTopWid(new QArrowWidget(":/icons/GLDDockPanel/top.png", this, CenterTopArea, parent)),
      centerBottomWid(new QArrowWidget(":/icons/GLDDockPanel/bottom.png", this, CenterBottomArea, parent)),
      parentWid(parent)
{
    leftWid->hide();
    rightWid->hide();
...
void GLDDockArrows::show(int dockArea)
{
...
DockArea GLDDockArrows::getDockAreaByPos(QPoint pos)
{
